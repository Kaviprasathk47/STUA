        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 mt-6">
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {vehicles.map((vehicle) => (
                        <div
                            key={vehicle._id}
                            className="border border-slate-200 rounded-xl p-4 hover:shadow-md transition-shadow relative group"
                        >
                            ...
                            <div className="space-y-2 text-sm text-slate-600">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-slate-600">{vehicle.vehicle_engine_size || "N/A"}</span>
                                </div>
                            </div>
                        </div>
                    ))}
            ...
            {showAddForm && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade">
                    <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl p-6 md:p-8 transform transition-all animate-scale-in border border-slate-100">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all placeholder:text-slate-400"
                                />
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            onChange={handleInputChange}
                                            className="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all appearance-none bg-white"
                                        >
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            className={`w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all appearance-none bg-white ${formData.vehicle_type === "Cycle" ? "bg-slate-100 text-slate-400 cursor-not-allowed" : ""}`}
                                        >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all text-slate-600"
                                    />
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            className={`w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all appearance-none bg-white ${getEngineSizes().length === 1 && getEngineSizes()[0] === "N/A" ? "bg-slate-100 text-slate-400 cursor-not-allowed" : ""}`}
                                        >
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className={`w-full pl-4 pr-12 py-2.5 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 outline-none transition-all placeholder:text-slate-400 ${formData.vehicle_type === "Cycle" ? "bg-slate-100 text-slate-400 cursor-not-allowed" : ""}`}
                                        />
                            ...
                            <div className="pt-4 flex gap-3">
                                ...
                                <button
                                    type="submit"
                                    className="flex-[2] py-2.5 bg-indigo-600 text-white rounded-xl font-semibold hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-200"
                                >
